...
func checkEqualButCATIdentical(t *testing.T, x, y types.Type, comment string) {
...
func TestAxioms(t *testing.T) {
	checkEqualButCATIdentical(t, tPStr1, tPStr2, "tPstr{1,2}")
	checkEqualButCATIdentical(t, tChanInt1, tChanInt2, "tChanInt{1,2}")
}
