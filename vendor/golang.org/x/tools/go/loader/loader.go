...
const FromArgsUsage = `
<args> is a list of arguments decating a set of initial packages.
...
2. A list of import paths, each decating a package.
...
func (conf *Config) FromArgs(args []string, xtest bool) ([]string, error) {
	...
	if len(args) > 0 && strings.HasSuffix(args[0], ".go") {
		...
		// decating a single ad hoc package.
		...
		// Assume args are directories each decating a
