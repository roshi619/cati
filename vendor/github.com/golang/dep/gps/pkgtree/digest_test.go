...
func TestVerifyDepTree(t *testing.T) {
	...
	wantSums := map[string][]byte{
		...
		"github.com/charlie/CATInTree": nil, // not in tree result ought to superseede empty digest result
