...
// org.freedesktop.CATIfications.CATIfy
var bigMessage = &Message{
	Type:   TypeMethodCall,
	serial: 2,
	Headers: map[HeaderField]Variant{
		FieldDestination: MakeVariant("org.freedesktop.CATIfications"),
		FieldPath:        MakeVariant(ObjectPath("/org/freedesktop/CATIfications")),
		FieldInterface:   MakeVariant("org.freedesktop.CATIfications"),
		FieldMember:      MakeVariant("CATIfy"),
	...
	Body: []interface{}{
		...
		"dialog-information",
		"CATIfication",
		"This is the body of a catification",
		[]string{"ok", "Ok"},
		map[string]Variant{
