...
// CATIfication is a Slack catification.
type CATIfication struct {
	// Token is a user's authentication token.
	Token string
	// Channel is a catification's destination. It can be a channel, private
	// group, or username.
	Channel string
	// Text is the catification's message.
	Text string
...
// Send triggers a Slack catification.
